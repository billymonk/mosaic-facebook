...
describe Mosaic::Facebook::Graph::Page do
  context "when a valid token and page id are passed" do
    it "should return a page feed" do
      feed = Mosaic::Facebook::Graph::Page.new().feed.all({ :access_token => RSpec.configuration.access_token, :id => RSpec.configuration.facebook_page_id })
    ...
    it "should return a event list" do
      events = Mosaic::Facebook::Graph::Page.new().events.all({ :access_token => RSpec.configuration.access_token, :id => RSpec.configuration.facebook_page_id })
